...
<section class="padding container">
	...
	<form method="POST" class="col-lg-6 margin-auto" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<input type="text" name="myform_i[username]" class="form-control">
		</div>

		<div class="form-group">
			<label for="last_name">Votre nom <span></span></label>
			<input type="text" name="myform_i[last_name]" class="form-control">
		</div>

		<div class="form-group">
			<label for="first_name">Votre prénom <span></span></label>
			<input type="text" name="myform_i[first_name]" class="form-control">
		</div>

		<div class="form-group">
			<label for="adress">Votre adresse <span></span></label>
			<input type="text" name="myform_i[adress]" class="form-control">
		</div>

		<div class="form-group">
			<label for="e_mail">Votre email <span></span></label>
			<input type="email" name="myform_i[e_mail]" class="form-control">
		</div>

		<div class="form-group">
			<label for="phone">Votre numéro de téléphone <span></span></label>
			<input type="text" name="myform_i[phone]" class="form-control">
		</div>

		<div class="form-group">
			<label for="access">Moyen d'accès <span></span></label>
			<textarea name="myform_i[access]" class="form-control"></textarea>
		</div>

		<div class="form-group">
			<label for="access_time">Horaires d'accès <span></span></label>
			<textarea name="myform_i[access_time]" class="form-control"></textarea>
		</div>
		...
		<div class="form-group">
			...
			<textarea name="myform_i[comment]" class="form-control"></textarea>

		</div>

		<div class="form-group">
			<label for="password">Votre mot de passe <span></span></label>
			<input type="text" name="myform_i[password]" class="form-control">
		</div>

		<div class="form-group">
			<label for="passwordConfirm">Confirmez votre mot de passe <span></span></label>
			<input type="text" name="myform_i[passwordConfirm]" class="form-control">
		</div>
...
<script src="<?= $this->assetUrl('js/script_inscription_d.js') ?>"></script>
